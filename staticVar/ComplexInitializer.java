...
// Write a Java program to create a class called "ComplexInitializer" with a
//  static block that initializes multiple static variables (x, y, z) using 
//  complex logic. Print the values of these variables in the main method.